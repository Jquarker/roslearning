...
(cl:defmethod cl:initialize-instance :after ((m <coordinate>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'coordinate)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name topic-msg:<coordinate> is deprecated: use topic-msg:coordinate instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <coordinate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader topic-msg:x-val is deprecated.  Use topic-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <coordinate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader topic-msg:y-val is deprecated.  Use topic-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <coordinate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader topic-msg:z-val is deprecated.  Use topic-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'frame_id-val :lambda-list '(m))
(cl:defmethod frame_id-val ((m <coordinate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader topic-msg:frame_id-val is deprecated.  Use topic-msg:frame_id instead.")
  (frame_id m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<coordinate>)))
  ...
  "9eb74a11328521b704f7a4f80f046db9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'coordinate)))
  "Returns md5sum for a message object of type 'coordinate"
  "9eb74a11328521b704f7a4f80f046db9")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<coordinate>)))
  ...
  (cl:format cl:nil "float32 x~%float32 y~%float32 z~%string frame_id~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'coordinate)))
  "Returns full string definition for message of type 'coordinate"
  (cl:format cl:nil "float32 x~%float32 y~%float32 z~%string frame_id~%~%"))
